...
@section('title', 'Tambah Kelas - SmartSens')
@section('page-title', 'Tambah Kelas')
@section('page-description', 'Tambah kelas baru ke dalam sistem')
...
@section('content')
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Tambahkan kelas baru ke dalam sistem</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-xl border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Isi form di bawah ini untuk menambahkan kelas baru</p>
        </div>

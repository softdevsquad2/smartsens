                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-sm font-medium text-gray-900">{{ $walikelas->kelas->nama_kelas }}</div>
                                    <div class="text-xs text-gray-500">{{ $walikelas->kelas->jurusan->nama_jurusan ?? 'N/A' }}</div>
                                </div>
                            </div>
                        </dd>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <dd class="mt-1">
                            @if($walikelas->user)
                                <div class="flex items-center">
                                    <div class="w-6 h-6 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full flex items-center justify-center mr-2">
                                        <i class="fas fa-user text-white text-xs"></i>
                                    </div>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">{{ $walikelas->user->username }}</div>
                                        <div class="text-xs text-gray-500">Role: {{ ucfirst($walikelas->user->role) }}</div>
                                    </div>
                                </div>
                            @else

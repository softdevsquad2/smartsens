...
@section('title', 'Tambah Wali Kelas - SmartSens')
@section('page-title', 'Tambah Wali Kelas')
@section('page-description', 'Tambah wali kelas baru ke dalam sistem')
...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tambah Wali Kelas Baru</h1>
        <p class="mt-1 text-sm text-gray-600">Tambahkan wali kelas baru ke dalam sistem</p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                @error('id_user')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500">Pilih user account yang sudah ada untuk mengaitkan dengan wali kelas</p>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        console.log('WaliKelas form submitted');

        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Card Code</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($users as $index => $user)
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            @if($user->role == 'siswa' && $user->siswa && $user->siswa->kelas)
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-gray-500">{{ $user->siswa->kelas->jurusan->nama_jurusan ?? '' }}</span>
                                </div>
                            @elseif($user->role == 'guru' && $user->waliKelas && $user->waliKelas->kelas)
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-gray-500">{{ $user->waliKelas->kelas->jurusan->nama_jurusan ?? '' }}</span>
                                </div>
                            @else
                                <span class="text-gray-400 italic">-</span>
                            @endif
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            @if($user->card_code)
                                <span class="font-mono text-sm bg-gray-100 px-2 py-1 rounded">{{ $user->card_code }}</span>
                            @else
                                <span class="text-gray-400 italic">-</span>
                            @endif
                        </td>

...
<div class="bg-white shadow-sm rounded-xl border border-gray-200">
    ...
    <form action="{{ route('user.update', $user->id_user) }}" method="POST" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div id="siswa-field" style="display: none;">
                ...
                <select name="id_siswa" 
                    ...
                    @foreach($siswa as $s)
                        <option value="{{ $s->id_siswa }}" {{ old('id_siswa', $user->id_siswa) == $s->id_siswa ? 'selected' : '' }}>
            ...
            <div id="wali-kelas-field" style="display: none;">
                ...
                <select name="id_wali_kelas" 
                    ...
                    @foreach($waliKelas as $wk)
                        <option value="{{ $wk->id_wali_kelas }}" {{ old('id_wali_kelas', $user->id_wali_kelas) == $wk->id_wali_kelas ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="text" 
                       name="card_code" 
                       id="card_code" 
                       value="{{ old('card_code', $user->card_code) }}"

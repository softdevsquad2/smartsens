    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <a href="{{ route('guru.pelanggaran.form') }}"
            ...
            <div class="flex flex-col items-center text-center">
                <div
                    class="w-16 h-16 bg-gradient-to-r from-red-500 to-pink-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <a href="{{ route('guru.prestasi.form') }}"
            ...
            <div class="flex flex-col items-center text-center">
                <div
                    class="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
